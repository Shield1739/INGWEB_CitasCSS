...
use PDO;
use Shield1739\UTP\CitasCss\fluentpdo\queries\
{Insert, Select, Update, Delete};

/**
 * This code contains a couple of minor modifications needed to make it compatible with my project. -Shield1739
 *
...
class Query
{
    ...
    {
        $this->debug = false;
        $this->convertRead = false;
        $this->convertWrite = false;
    ...
    public function setTableName(?string $table = '', string $prefix = '', string $separator = ''): Query
    {
        ...
        {
            throw new FluentPdoException('Table name cannot be empty');
        }
