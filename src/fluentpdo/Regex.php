...
class Regex
{
     ...
     * @return false|int
     */
    public function compareLocation(string $subject, ?array &$matches = null, ?string $directory = null): bool|int
    {
     ...
     * @return false|int
     */
    public function sqlParameter(string $subject, ?array &$matches = null): bool|int
    {
     ...
     * @return false|int
     */
    public function tableAlias(string $subject, ?array &$matches = null): bool|int
    {
        return preg_match(
     ...
     * @return false|int
     */
    public function tableJoin(string $subject, ?array &$matches = null): bool|int
    {
     ...
     * @return false|int
     */
    public function tableJoinFull(string $subject, ?array &$matches = null): bool|int
    {
