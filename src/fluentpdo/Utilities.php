...
class Utilities
{
     ...
     * @param \Traversable|array $rows - provided by PDOStatement::fetch with PDO::FETCH_ASSOC
     *
     * @return array|\Traversable
     */
    public static function stringToNumeric(PDOStatement $statement, Traversable|array $rows): Traversable|array
    {
     ...
     * @return bool
     */
    #[Pure] public static function convertSqlWriteValues($value)
    {
        if (is_array($value))
        {
     ...
     * @return int|string
     */
    public static function convertValue($value): int|string
    {
     ...
     */
    #[Pure] public static function nullToLiteral($value): mixed
    {
        if ($value === null)
        {
